...
***************************************
	...
	tabstatmat A
	matrix TAB = A'
	xml_tab TAB, rnames(Average)cnames(BZ CH Darkhan Erdenet SKH Overall) format((s2110 n2101)) title("Table 6. Average Nubmer of Household Members Employed") save(results.xls) replace
...
***************************************
	...
	tabstatmat A
	matrix TAB = A'
	xml_tab TAB, rname("Average Number of Vehicles Owned" "Average Value of All Vehicles by HH (1,000 MNT)") cnames(BZ CH Darkhan Erdenet SKH Overall) format((s2110 n2102 n2100)) title("Table 7. Household Vehicle Ownership") append save(results.xls)
...
***************************************
	...
	*We need to convert the dataset to long form by family member for this table
			/* Question 2_3_1-7
		HH member’s participation level in the interview 
		1=Main respondent
